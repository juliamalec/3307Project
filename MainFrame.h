...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(218, 406);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(343, 81);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Get your life together!";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &MainFrame::button1_Click);
			this->button1->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &MainFrame::button1_MouseClick);
			// 
			// label1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 28.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(265, 146);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(246, 54);
			this->label1->TabIndex = 1;
			this->label1->Text = L"OnTrack()";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(288, 218);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(188, 32);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Calander App";
			this->label2->Click += gcnew System::EventHandler(this, &MainFrame::label2_Click);
			// 
			// MainFrame
			// 
